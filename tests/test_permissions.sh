...
echo ""
echo "=== Step 4: Microphone Permission Dialog ==="
echo "  1. If microphone permission was previously denied, reset it:"
echo "     tccutil reset Microphone com.were.VoicePaste"
echo "  2. Press and hold Option + Space to trigger recording"
echo "  3. Deny microphone permission when prompted"
echo "  4. Observe: 'Microphone Access Required' dialog appears"
echo "  5. Verify dialog has 'Open System Settings' and 'Cancel' buttons"
echo "  6. Click 'Open System Settings'"
echo "  7. Verify System Settings opens to Microphone pane (or Privacy & Security)"
echo "  8. Enable VoicePaste in the Microphone list"
echo ""
echo "=== Step 5: Test Hotkey Detection ==="
...
echo ""
echo "=== Step 6: Test API Key Setup ==="
...
echo ""
echo "=== Step 7: Test Transcription ==="
echo "  1. Ensure API key is configured (Step 6)"
...
echo "  [ ] Microphone denial shows 'Microphone Access Required' dialog"
echo "  [ ] Dialog has 'Open System Settings' and 'Cancel' buttons"
echo "  [ ] 'Open System Settings' opens Microphone or Privacy & Security pane"

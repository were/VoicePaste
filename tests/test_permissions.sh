...
echo "  5. Quit and relaunch the app"
echo "  6. Verify the API key persists after relaunch"
echo "  7. Click 'Clear' to remove the key"
echo "  8. Verify the key is removed"
echo ""
...
echo "  6. Observe: 'Transcribing...' state in overlay"
echo "  7. Wait for transcription to complete"
echo "  8. Observe: Text should appear in the editor"
echo ""
...
echo "  [ ] Transcribing state shown in overlay"
